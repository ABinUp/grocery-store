...
public class ProductImageService {
	 ...
	 * @return
	 */
	@Cacheable(key="'productImagesSingle-pid'+#p0.id")
	 ...
	 * @return
	 */
	@Cacheable(key="'productImagesDetail-pid'+#p0.id")
...
//		}
		ProductImageService bean = SpringContextUtil.getBean(ProductImageService.class);
		 List<ProductImage> singleImages = bean.listSingleProductImages(product);
